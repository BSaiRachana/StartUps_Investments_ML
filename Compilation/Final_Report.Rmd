...
```{r setup, echo=FALSE}
knitr::opts_knit$set(root.dir = '/Users/vineethpenugonda/Documents/Academics/Masters/Semester IV/IST 5535/Projects/StartUps_Investments_ML/Dataset/' )
```
...
viz_data %>% count(founded_year)%>% arrange(-n) %>% head(25) %>%
  ...
  geom_text(aes(x = founded_year, y=2000, label = "Uber,"), data = viz_data %>% filter(name == "Uber"), size=4, vjust=-0.3, hjust=0.6) +
