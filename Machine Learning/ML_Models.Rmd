...
set.seed(100)
rf_fit <- train(post_success ~ ., data = trainData, method="rf", trControl=fitControl)
```
...
legend("right", legend = c("Logit", "GBM", "KNN", "RF", "SVM"), col = c("blue", "green", "red", "pink", "orange"), lty = 1)
